<script>
  ...
  import { getPayloadConfigFromPayload, getChartContext } from './chart-utils.js';
...
<TooltipPrimitive.Root variant="none">
  <div
    class={cn(
      'border-border/50 bg-background grid min-w-36 items-start gap-1.5 rounded-xs border px-2.5 py-1.5 text-xs shadow-xl',
      className
    )}
    {...restProps}
  >
